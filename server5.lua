--[================================================================]--
-- Advanced Anti-VoteKick / Serverban Hop Script (Per-Account Storage)
--[================================================================]--
...
local FILENAME = "banned_servers_" .. LocalPlayer.Name .. ".json"
...
-------------------------------------------------------------------------
-- Persistent Storage Management (Account-Specific)
-------------------------------------------------------------------------
...
-------------------------------------------------------------------------
-- UI Elements Creation (Transparent, outlined text, account-specific)
-------------------------------------------------------------------------
...
local function updateUIList()
    ...
    -- Banned JobIds for this specific account (Red with outline)
...
print("[ServerHop Manager] Loaded with account-isolated list: " .. FILENAME)
